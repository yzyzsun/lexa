  $ lexa ../../benchmarks/lexa/resume_nontail/main.lx -o main &> /dev/null
  ...
  FAST_SWITCH_DECORATOR
  i64 __handler_operator_stub_lifted_7___operator(i64 *__env__, i64 x, i64 k) {
    return (({
      ...
      i64 out = ({
        ...
        ({
          ...
          ({
            i64 s = (i64)(((i64 *)__env__)[2]);
            (((i64(*)(i64, i64, i64, i64))__loop_lifted_1__)(
                (i64)0, (i64)n, (i64)s, (i64)operator_stub));
          });
        });
      });
      __asm__("" : "+r"(out));
