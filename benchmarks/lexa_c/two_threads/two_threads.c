...
static i64 __ackermann_lifted_1__(i64, i64, i64, i64, i64);
...
static i64 __ackermann_lifted_1__(i64 __env__, i64 m, i64 n, i64 quota,
  ...
  return (({
    (((((i64 *)quota)[0]) == 0)
         ? (((i64 *)quota)[0] = (RAISE_F(thread_stub, yield, ((i64)0))))
         : 0);
    ({
      ...
      ((m == 0)
           ...
           : ((n == 0) ? (({
               __attribute__((musttail)) return (
                   ...
                   (i64)0, (i64)(m - 1), (i64)1, (i64)quota, (i64)thread_stub);
               0;
             }))
                       : (({
                           __attribute__((musttail)) return ((i64(*)(
                               ...
                               (i64)(((i64(*)(i64, i64, i64, i64,
                                              i64))__ackermann_lifted_1__)(
                                   (i64)0, (i64)m, (i64)(n - 1), (i64)quota,
                                   (i64)thread_stub)),
                               (i64)quota, (i64)thread_stub);
                           0;
                         }))));
    });
  }));
